...
def main():
    parser = argparse.ArgumentParser(description="Simple tool to generte a stencil for text provided in stdin")

    parser.add_argument('-f', '--font', required=True, help="Font to write text with")
    parser.add_argument('-s', '--size', type=int, default=300, help="Font size in pixels")
    parser.add_argument('-F' , '--flip', action='store_true', help="Flip final image horizontally")
